...
Procedure Main
   ...
   // *---------------------------------------------------------------------*
   // METODO DE IMPRESSÃO LIVRE ( CÓDIGO BARRAS )
   // *---------------------------------------------------------------------*
   F_BarCodes( oMRPrint )
...
//
// *---------------------------------------------------------------------*
Function F_BarCodes( oMRPrint )

   LOCAL cZebra := '789789990018'
   ...
   // *---------------------------------------------------------------------*
   oMRPrint:hZebra_______ := hb_zebra_create_ean13( cZebra, '' )
   IF ( oMRPrint:hZebra_______ != NIL )

      IF hb_zebra_geterror( oMRPrint:hZebra_______ ) == 0
         oMRPrint:Draw_Zebra( ( oMRPrint:Page_Width___ * 0.50 ), ( oMRPrint:Page_Height__ * 0.50 ), 1.00, -( oMRPrint:Page_Height__ * 0.045 ) )

      ELSE
         ? "Error", hb_zebra_geterror( oMRPrint:hZebra_______ )
      ENDIF
