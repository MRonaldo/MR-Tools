...
Create Class MR_Boleto
   ...
   // *---------------------------------------------------------------------*
   // Benefici?rio: Prefixo ( Parte Integrante do Nosso Numero )
   // *---------------------------------------------------------------------*
   DATA Prefixo______   INIT '0'
   DATA Prefixo_DV___   INIT ''

   // *---------------------------------------------------------------------*
   // Benefici?rio: Carteira
   // *---------------------------------------------------------------------*
   ...
   // *---------------------------------------------------------------------*
   // Boleto: Representa??o Numerica do Codigo de Barras
   // *---------------------------------------------------------------------*
   DATA Cod_Barras___   INIT ''
   DATA Cod_Barras_DV   INIT ''

   // *---------------------------------------------------------------------*
   // Boleto: Origem do valor ( NF, NFe, NFSe, Duplicata, Promiss?ria, etc... )
   // *---------------------------------------------------------------------*
   ...
   // *---------------------------------------------------------------------*
   // Boleto: Instrucoes: {} ( Exemplo: instrucoes e discrimina??o da Cobranca)
   // *---------------------------------------------------------------------*
   ...
   // *---------------------------------------------------------------------*
   // Representa??o gr?fica para o Codigo de Barras
   // *---------------------------------------------------------------------*
   DATA hZebra_______
...
METHOD AddPage() Class MR_Boleto
   ...
   // *---------------------------------------------------------------------*
   // 1a Via - Controle do Benefici?rio
   // *---------------------------------------------------------------------*
...
METHOD Execute() Class MR_Boleto
   ...
   // *---------------------------------------------------------------------*
   // REPRESENTA??O NUMERICA DO CODIGO DE BARRAS
   // *---------------------------------------------------------------------*
...
METHOD Banco_748() Class MR_Boleto
   ...
   ::Ag_Cd_Benefic := ::Banco_Agencia + '/' + ::Banco_Ag_Un_A + '/' + ::Conta________ + '-' + ::Conta_DV_____
