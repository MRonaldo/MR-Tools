...
#define Font_Fixa_b___    "Courier-Bold"
#define Font_Fixa_i___    "Courier-Oblique"
#define Font_Fixa_bi__    "Courier-BoldOblique"
#define Font_Var______    "Helvetica"
#define Font_Var_b____    "Helvetica-Bold"
#define Font_Var_i____    "Helvetica-Oblique"
#define Font_Var_bi___    "Helvetica-BoldOblique"
...
#define Line_Max_H_arr   82
#define Line_Max_H_Dbf   82
#define Line_Max_H_Prn   82
#define Line_Max_H_Txt   82
...
Create Class MR_Print
   ...
   /* Fonte para Impressão: Fixa: Courier */
   VAR oFont_f______
   VAR oFont_f_b____
   VAR oFont_f_i____
   VAR oFont_f_bi___

   /* Fonte para Impressão: Variavel: Helvetica */
   VAR oFont_v______
   VAR oFont_v_b____
   VAR oFont_v_i____
   VAR oFont_v_bi___
   ...
   /* Objetos */
   VAR Logo_File____   INIT 'Resources\Imatech.jpg'
...
Method MR_Print:New( cFilePdf )
   ...
   /* Fonte Tamanho Fixo */
   ::oFont_f______ := HPDF_GetFont( ::obPdf, Font_Fixa_____, Font_Code_Page )
   ::oFont_f_b____ := HPDF_GetFont( ::obPdf, Font_Fixa_b___, Font_Code_Page )
   ::oFont_f_i____ := HPDF_GetFont( ::obPdf, Font_Fixa_i___, Font_Code_Page )
   ::oFont_f_bi___ := HPDF_GetFont( ::obPdf, Font_Fixa_bi__, Font_Code_Page )

   /* Fonte Espaçamento Variavel */
   ::oFont_v______ := HPDF_GetFont( ::obPdf, Font_Var______, Font_Code_Page )
   ::oFont_v_b____ := HPDF_GetFont( ::obPdf, Font_Var_b____, Font_Code_Page )
   ::oFont_v_i____ := HPDF_GetFont( ::obPdf, Font_Var_i____, Font_Code_Page )
   ::oFont_v_bi___ := HPDF_GetFont( ::obPdf, Font_Var_bi___, Font_Code_Page )
      ...
      IF HB_ISSTRING( aPrint[ 1 ] )
         ...
         FOR i := 1 TO iMax
            ...
            IF aPrn[ Prn_Page_New__ ]
               ...
               aPrn[ Page_Line_h___ ] := ( ::Page_Height__ / Line_Max_H_arr )
...
Method MR_Print:PrnToPdf( cFile, nFont )
   ...
   IF !( oFile:Error() )
      ...
      IF aPrn[ Prn_Lines_Max_ ] > 0
         IF aPrn[ Prn_Lines_Max_ ] > 33
            aPrn[ Prn_Lines_Max_ ] := IIF( aPrn[ Prn_Lines_Max_ ] > Line_Max_H_Prn, Line_Max_H_Prn, aPrn[ Prn_Lines_Max_ ] )
         ELSE
            aPrn[ Prn_Lines_Max_ ] := IIF( aPrn[ Prn_Lines_Max_ ] > 30, 66, 88 )
         ENDIF
      ELSE
         aPrn[ Prn_Lines_Max_ ] := Line_Max_H_Prn
      ENDIF
   ...
   IF !( oFile:Error() )
      ...
      WHILE oFile:MoreToRead()
         ...
         IF aPrn[ Prn_Page_New__ ]
            ...
            // Dimensoes para objetos
            aPrn[ Page_Left_____ ] := ( ::Page_Width___ * 0.050 )
            aPrn[ Page_Line_h___ ] := ( ::Page_Height__ / Line_Max_H_Txt )
